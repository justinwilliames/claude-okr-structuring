...
```bash
git clone https://github.com/justinwilliames/claude-okr-structuring.git ~/code/claude-okr-structuring
ln -s ~/code/claude-okr-structuring ~/.claude/skills/okr-structuring
```
